...
const About = () => {
  const stats = [
    { value: "25.4M+", label: "Campaign Reach" },
    { value: "13.7", label: "Years in Business" },
    { value: "25", label: "Team Members" },
    { value: "34M+", label: "Revenue Generated" }
  ];

  return (
    <section id="about" className="section bg-zue-dark-light">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            ...
            <div className="space-y-3 mb-8">
              {["Results-driven strategies tailored to your goals", 
                ...
                "Dedicated team of industry experts"].map((item, index) => (
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-4">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className="bg-zue-card-dark p-6 rounded-lg border border-zue-dark flex flex-col items-center justify-center text-center"
              >
